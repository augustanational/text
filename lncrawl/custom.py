# bash -c mkdir /data && apt-get update && apt-get install -y --no-install-recommends wget && wget https://cdn.jsdelivr.net/gh/augustanational/text@1447c66b9f17e83284ba39f54d2a08340902ca76/lncrawl/config.json --output-document=/app/config.json && /app/.venv/bin/python -m lncrawl -ll -c /app/config.json server
...
search_url = "https://truyenfull.mobi/tim-kiem/?tukhoa=%s"
...
class TruenFull(LegacyCrawler):
    ...
    def parse_truyenfull_chapters(self, soup: PageSoup):
        ...
        for page in range(total_page):
            ...
            url = "https://truyenfull.mobi/ajax.php?" + params
